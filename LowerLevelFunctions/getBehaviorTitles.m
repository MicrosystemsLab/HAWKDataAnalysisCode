%%%% Function: get behavior titles
%  returns the titles of the columns for excel data export.  
%
%  returns {titles}, cell<string>
%
...
titles = {
    ...
    'STD Track Velocity'
    'Average Track Acceleration'
    'STD Track Acceleration'
