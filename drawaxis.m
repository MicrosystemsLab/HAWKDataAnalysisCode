...
%     tick_top = 0;
    tick_top = props.TickLength(1)*diff(props.YLim);
    
    h_xaxis = line(props.XLim, [0 0] + myX_Crossing, 'color', axes_color,'LineWidth',props.LineWidth);
    ...
    if ~isempty(props.XTick)
        ...
        h_ticks = line(xtick_x, xtick_y, 'color', axes_color,'LineWidth',props.LineWidth);
    ...
    if strcmp(lower(props.XMinorTick), 'on')
        ...
        for iCount = 1:nTicks - 1
            ...
            h_minors = line(xminors_x, xminors_y, 'color', axes_color,'LineWidth',props.LineWidth);
        end
